...
$string['privacy:metadata:mootimetertool_wordcloud_answers'] = 'The wordcloud tool stores user submissions.';
$string['privacy:metadata:mootimetertool_wordcloud_answers:optionid'] = 'Option ID';
$string['privacy:metadata:mootimetertool_wordcloud_answers:pageid'] = 'Page ID';
$string['privacy:metadata:mootimetertool_wordcloud_answers:timecreated'] = 'Submission created';
$string['privacy:metadata:mootimetertool_wordcloud_answers:timemodified'] = 'Submission modified';
$string['privacy:metadata:mootimetertool_wordcloud_answers:userid'] = 'User ID';
...
$string['wordcloud_aria_label'] = 'Word cloud with {$a} terms';
